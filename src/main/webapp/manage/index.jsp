...
<html>
  <head>
    ...
    <link rel="stylesheet" href="<%=basePath%>manage/common/css/amazeui.min.css" />
    <link rel="stylesheet" href="<%=basePath%>manage/common/css/admin.css">
    <link rel="stylesheet" href="<%=basePath%>manage/common/css/app.css">
    <script src="<%=basePath%>manage/common/js/echarts.min.js"></script>
  </head>
  ...
  <body data-type="index">
    ...
    <header class="am-topbar am-topbar-inverse admin-header">
        <div class="am-topbar-brand">
            <a href="javascript:;" class="tpl-logo">
                <img src="<%=basePath%>manage/common/img/logo.png" alt="">
            </a>
        </div>
            ...
            <ul class="am-nav am-nav-pills am-topbar-nav am-topbar-right admin-header-list tpl-header-list">
                ...
                <li class="am-dropdown" data-am-dropdown data-am-dropdown-toggle>
                    ...
                    <ul class="am-dropdown-content tpl-dropdown-content">
                      ...
                      <img src="<%=basePath%>manage/common/img/user02.png" alt=""> </span>
                      ...
                      <span class="tpl-dropdown-content-from"> 禁言小张 </span>
                            ...
                            <a href="#" class="tpl-dropdown-content-message">
                                <span class="tpl-dropdown-content-photo">
                      <img src="<%=basePath%>manage/common/img/user03.png" alt=""> </span>
                                <span class="tpl-dropdown-content-subject">
                ...
                <li class="am-dropdown" data-am-dropdown data-am-dropdown-toggle>
                    <a class="am-dropdown-toggle tpl-header-list-link" href="javascript:;">
                        <span class="tpl-header-list-user-nick">${username }</span><span class="tpl-header-list-user-ico"> <img src="<%=basePath%>manage/common/img/user01.png"></span>
                    </a>
        ...
        <div class="tpl-left-nav tpl-left-nav-hover">
            ...
            <div class="tpl-left-nav-list">
                <ul class="tpl-left-nav-menu">
                    ...
                    <li class="tpl-left-nav-item">
                        <a href="<%=basePath%>manage/chart/chart.jsp" class="nav-link tpl-left-nav-link-list">
               ...
               12
                    ...
                    <li class="tpl-left-nav-item">
                        ...
                        <ul class="tpl-left-nav-sub-menu">
                            <li>
                                <a href="<%=basePath%>manage/table/table-font-list.jsp">
                        ...
                        <div class="tpl-scrollable">
                            ...
                            <table class="am-table tpl-table">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <img src="<%=basePath%>manage/common/img/user01.png" alt="" class="user-pic">
                                    ...
                                    <tr>
                                        <td>
                                            <img src="<%=basePath%>manage/common/img/user02.png" alt="" class="user-pic">
                                    ...
                                    <tr>
                                        <td>
                                            <img src="<%=basePath%>manage/common/img/user03.png" alt="" class="user-pic">
                                    ...
                                    <tr>
                                        <td>
                                            <img src="<%=basePath%>manage/common/img/user04.png" alt="" class="user-pic">
                                    ...
                                    <tr>
                                        <td>
                                            <img src="<%=basePath%>manage/common/img/user05.png" alt="" class="user-pic">
                                    ...
                                    <tr>
                                        <td>
                                            <img src="<%=basePath%>manage/common/img/user06.png" alt="" class="user-pic">
    ...
    <script src="<%=basePath%>manage/common/js/jquery.min.js"></script>
    <script src="<%=basePath%>manage/common/js/amazeui.min.js"></script>
    <script src="<%=basePath%>manage/common/js/iscroll.js"></script>
    <script src="<%=basePath%>manage/common/js/app.js"></script>
</body>
